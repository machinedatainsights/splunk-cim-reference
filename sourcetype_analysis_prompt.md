...
- data_models - List up to 3 applicable CIM data models in format: data_model.dataset (e.g., Authentication.Authentication, Network_Traffic.All_Traffic). Use ONLY data models from 'splunk_data_model_objects_fields_850.csv'
...
- Reference the 'splunk_data_model_objects_fields_850.csv' file for ALL data model assignments
...
- Reference the 'security_classifications_reference.md' for ALL classifications
...
Please analyze the attached 'sourcetypes_list.csv' file and generate the complete analysis. Your output is a 'cim_sourcetype_inventory_<date-timestamp>.csv' file.
...
And this sourcetype_analysis_prompt.md to serve as the prompt and guide for the analysis.
